...
public static class HellMonsterConfigs
{
    ...
    static HellConfig Hound() => new HellConfig
    {
        ...
        maxHP = 220, moveSpeed = 5.4f, attackDamage = 32f, attackRange = 3.9f, attackCooldown = 1.4f,
    ...
    static HellConfig Bat() => new HellConfig
    {
        ...
        folderName = "헬뱃",
        maxHP = 160, moveSpeed = 5.2f, attackDamage = 26f, attackRange = 2.3f, attackCooldown = 1.2f,
    ...
    static HellConfig Bug() => new HellConfig
    {
        ...
        folderName = "헬버그",
        maxHP = 260, moveSpeed = 3.6f, attackDamage = 36f, attackRange = 2.8f, attackCooldown = 1.8f,
    ...
    static HellConfig Demon() => new HellConfig
    {
        ...
        folderName = "헬플라잉데몬",
        maxHP = 180, moveSpeed = 4.4f, attackDamage = 30f, attackRange = 2.6f, attackCooldown = 1.6f,
        visionRange = 20f, visionAngle = 300f,
    ...
    static HellConfig Cyclop() => new HellConfig
    {
        ...
        folderName = "헬사이클롭",
        maxHP = 520, moveSpeed = 3.2f, attackDamage = 48f, attackRange = 3.4f, attackCooldown = 2.4f,
