...
Shader "Vefects/SH_Vefects_BIRP_Glow_Flare_Add_01"
{
	Properties
	{
		...
		_LUTPanSpeed("LUT Pan Speed", Float) = 0.1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 temp_cast_1 = (( ( tex2DNode16.g * ( i.uv2_texcoord2.x * _LUTAmplitude ) ) + ( i.uv2_texcoord2.y + _LUTOffset ) )).xx;
			float2 panner35 = ( 1.0 * _Time.y * temp_cast_0 + temp_cast_1);
			...
			float temp_output_18_0 = saturate( ( saturate( ( saturate( tex2DNode16.g ) * i.vertexColor.a ) ) * distanceDepth26 ) );
			o.Emission = ( ( ( i.vertexColor * float4( tex2D( _LUT, panner35 ).rgb , 0.0 ) ) * temp_output_18_0 ) * ( _Emission * i.uv_texcoord.z ) ).rgb;
...
/*ASEBEGIN
Version=19701
Node;AmplifyShaderEditor.TexCoordVertexDataNode;38;-2816,896;Inherit;False;1;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;33;-2432,768;Inherit;False;Property;_LUTAmplitude;LUT Amplitude;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-2432,0;Inherit;True;Property;_MainTexture;Main Texture;5;0;Create;True;0;0;0;False;3;Space(33);Header(Main Texture);Space(13);False;-1;205ff18512f608544b5e2b5ea1452f77;205ff18512f608544b5e2b5ea1452f77;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;-2432,640;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-2176,768;Inherit;False;Property;_LUTOffset;LUT Offset;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;19;-1664,-384;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;37;-1664,256;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-2432,512;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;40;-2176,640;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;32;-2176,512;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-1920,640;Inherit;False;Property;_LUTPanSpeed;LUT Pan Speed;4;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
...
WireConnection;42;9;18;0
ASEEND*/
//CHKSM=E2B93915CBCA8040C289BE2D018CF9CED4E12FDD