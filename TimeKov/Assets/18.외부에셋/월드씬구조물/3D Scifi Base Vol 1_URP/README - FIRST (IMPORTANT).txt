...
badbarkingdog@gmail.com

https://www.facebook.com/BigBarkingDog/

https://twitter.com/bad_barking_dog

https://www.creepycat.fr/#about



Hi dear customer :) 

I'm glad to present my new scifi kit! It's the result of few days of work (5 months full
time, to be exact) i hope that the kit give you satisfaction, i'm always proud when i see
some games made with my datas.
...
When you load the kit, is it possible that the rendering was black! Do not panic...
Just open the window lightning and re-bake the lightning... Do not send me mail :)

The kit work very well with this : https://github.com/keijiro/KinoObscurance
One of the better SSAO i have see... Do not contact me for support about it...
...
"Door_L" (put them to static off) 
"Door_R" (put them to static off) 

This operation allow you to get the door opening, but! If you you want to lightmap/bake
you need to redo the same operation (search) but static them again!

I know it's a pain in the ass, but i don't make the rules :)

--------------------------------
About the damn missing object :)
--------------------------------
...
"The pack suxx, i need a scanner!"
"I want a computer like startrek!" 
"There is a missing object, a solar panel"
...
The textures named XXX_Dif.png are some ID textures, you can use them with DDO. In fact
all you need for ddo is provided : ID / AO / NORM / METAL
